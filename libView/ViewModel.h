...
//    mat4  m;
  ...
  void dump( FILE *output ) {
    ...
    eye.print(    output, (char*) "  eye"    );
    lookat.print( output, (char*) "  lookat" );
    up.print(     output, (char*) "  up"     );
    side.print(   output, (char*) "  side"   );
    forward.print(output, (char*) "  forward");
    mtx.print(    output, (char*) "  mtx"    );
  }
};
